...
if __name__ == '__main__':
    ...
    eg = ExperimentGrid(name='fourcars-env1-v2_ppo')
    eg.add('env_name', 'gym_lass:HighwayFourCars-env1-v2', '', in_name=True)
    eg.add('seed', [50])
    eg.add('epochs', 100)
    ...
    env = gym.make('HighwayFourCars-env1-v2', display=False, record=True)
